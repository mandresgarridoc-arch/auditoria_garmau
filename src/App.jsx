...
const InyeccionSQL = () => (
  <div className="animate-fade-in space-y-6 pb-8">
    ...
    <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 border-t-4 border-t-red-500 print:shadow-none print:border-slate-300 print:border-t-red-600">
      ...
      <div className="w-full bg-slate-50 dark:bg-slate-950 rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-700 p-8 flex flex-col items-center justify-center mb-6 print:bg-white print:border-slate-300 print:p-4">
        <img src="/img/sqli_garmau.png" alt="Evidencia SQLi" className="max-w-full h-auto rounded shadow-lg print:block print:shadow-none print:border print:border-slate-200" />
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div className="bg-slate-50 dark:bg-slate-800/50 p-6 rounded-xl border border-slate-100 dark:border-slate-700/50 print:bg-white print:border-slate-300">
        ...
        <div className="bg-red-50 dark:bg-red-900/10 p-6 rounded-xl border border-red-100 dark:border-red-900/30 print:bg-white print:border-slate-300">
      ...
      <div className="mt-8 flex flex-wrap gap-4">
        ...
        <div className="bg-emerald-50 dark:bg-emerald-900/20 px-6 py-4 rounded-xl border border-emerald-200 dark:border-emerald-800/50 flex-[2] min-w-[300px] shadow-sm print:bg-white print:border-slate-300">
...
const XSS = () => (
  <div className="animate-fade-in space-y-6 pb-8">
    ...
    <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 border-t-4 border-t-orange-500 print:shadow-none print:border-slate-300 print:border-t-orange-600">
      <h3 className="text-xl font-bold mb-6 flex items-center gap-2 print:text-black">
        <Terminal className="text-orange-500" /> Evidencia del Ataque (Reflejado)
      </h3>
      
      <div className="w-full bg-slate-50 dark:bg-slate-950 rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-700 p-8 flex flex-col items-center justify-center mb-6 print:bg-white print:border-slate-300 print:p-4">
        <img src="/img/xss_garmau.png" alt="Evidencia XSS" className="max-w-full h-auto rounded shadow-lg print:block print:shadow-none print:border print:border-slate-200"/>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-orange-50 dark:bg-orange-900/10 p-6 rounded-xl border border-orange-100 dark:border-orange-900/30 print:bg-white print:border-slate-300">
...
const Comandos = () => (
  <div className="animate-fade-in space-y-6 pb-8">
    ...
    <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 border-t-4 border-t-purple-500 print:shadow-none print:border-slate-300 print:border-t-purple-600">
      <h3 className="text-xl font-bold mb-6 flex items-center gap-2 print:text-black">
        <Server className="text-purple-500" /> Evidencia del Ataque (OS Command)
      </h3>
      
      <div className="w-full bg-slate-50 dark:bg-slate-950 rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-700 p-8 flex flex-col items-center justify-center mb-6 print:bg-white print:border-slate-300 print:p-4">
        <img src="/img/comandos_garmau.png" alt="Evidencia Comandos" className="max-w-full h-auto rounded shadow-lg print:block print:shadow-none print:border print:border-slate-200"/>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-purple-50 dark:bg-purple-900/10 p-6 rounded-xl border border-purple-100 dark:border-purple-900/30 print:bg-white print:border-slate-300">
...
const Activos = () => (
  <div className="animate-fade-in space-y-6 pb-8">
    ...
    <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 mb-6 print:shadow-none print:border-slate-300">
    ...
    <div className="grid md:grid-cols-3 gap-6">
      <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-200 dark:border-slate-800 border-t-4 border-t-red-500 flex flex-col print:shadow-none print:border-slate-300 print:border-t-red-600">
        <Database className="text-red-500 mb-4 drop-shadow-md print:drop-shadow-none" size={32} />
      ...
      <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-200 dark:border-slate-800 border-t-4 border-t-orange-500 flex flex-col print:shadow-none print:border-slate-300 print:border-t-orange-600">
        <Fingerprint className="text-orange-500 mb-4 drop-shadow-md print:drop-shadow-none" size={32} />
      ...
      <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-200 dark:border-slate-800 border-t-4 border-t-purple-500 flex flex-col print:shadow-none print:border-slate-300 print:border-t-purple-600">
        <Server className="text-purple-500 mb-4 drop-shadow-md print:drop-shadow-none" size={32} />
...
const Matriz = () => {
  ...
  for (let i = 5; i >= 1; i--) {
    const row = [];
    for (let p = 1; p <= 5; p++) {
      const vulnsHere = riesgosData.filter(r => parseInt(r.prob) === p && parseInt(r.imp) === i);
  ...
  return (
    <div className="animate-fade-in space-y-6 pb-8">
      ...
      <div className="grid lg:grid-cols-12 gap-6 mb-6">
        ...
        <div className="lg:col-span-5 bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 flex flex-col items-center justify-center print:shadow-none print:border-slate-300">
          <h3 className="text-lg font-bold mb-4 flex items-center gap-2 print:text-black">
            <Activity className="text-rose-500" size={20}/> Mapa de Calor
          </h3>
          <div className="relative inline-flex flex-col bg-slate-50 dark:bg-slate-950 p-4 md:p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-inner print:bg-white print:border-slate-300">
        ...
        <div className="lg:col-span-7 bg-emerald-50 dark:bg-black text-slate-900 dark:text-white p-6 md:p-8 rounded-2xl shadow-lg border border-emerald-200 dark:border-slate-800 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] print:bg-white print:border-slate-300 print:shadow-none print:text-black flex flex-col justify-center">
          <h3 className="text-xl font-bold mb-6 flex items-center gap-2 print:text-black"><Activity className="text-emerald-600 dark:text-rose-400 print:text-rose-600"/> Análisis de Priorización</h3>
          <div className="space-y-4">
            <div className="flex gap-4 items-start">
              <div className="w-8 h-8 rounded-full bg-red-100 dark:bg-red-600/30 text-red-700 dark:text-red-400 flex items-center justify-center font-black shrink-0 border border-red-200 dark:border-red-500/50 print:bg-red-50 print:text-red-700 print:border-red-300 text-sm">1</div>
              <div>
            ...
            <div className="flex gap-4 items-start">
              <div className="w-8 h-8 rounded-full bg-orange-100 dark:bg-orange-500/20 text-orange-700 dark:text-orange-400 flex items-center justify-center font-black shrink-0 border border-orange-200 dark:border-orange-500/30 print:bg-orange-50 print:text-orange-700 print:border-orange-300 text-sm">2</div>
              <div>
            ...
            <div className="flex gap-4 items-start">
              <div className="w-8 h-8 rounded-full bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-400 flex items-center justify-center font-black shrink-0 border border-amber-200 dark:border-amber-500/30 print:bg-amber-50 print:text-amber-700 print:border-amber-300 text-sm">3</div>
              <div>
      ...
      <div className="bg-white dark:bg-slate-900 p-4 md:p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 hover:shadow-lg transition-shadow print:shadow-none print:border-slate-300 print:p-0">
        
        {/* VISTA MÓVIL: Formato Tarjetas */}
        <div className="md:hidden space-y-4 print:hidden">
          {riesgosData.map((r) => (
            <div key={`mobile-${r.id}`} className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-100 dark:border-slate-700/50 shadow-sm">
              <div className="flex items-center gap-2 font-bold text-base text-slate-800 dark:text-slate-200 mb-3 border-b border-slate-200 dark:border-slate-700 pb-2">
                {r.iconMobile} {r.vuln}
              </div>
  ...
  <div className="animate-fade-in space-y-6 pb-8">
    <div className="flex items-center gap-4 mb-8">
      ...
      <h2 className="text-4xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-blue-500 dark:from-indigo-400 dark:to-blue-300">
        Defensa en Profundidad (Controles)
      </h2>
    </div>
    ...
    <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-6">
      {/* CAPA 1: PREVENCIÓN */}
      <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-800 border-t-4 border-t-indigo-500 relative flex flex-col print:shadow-none print:border-slate-300 print:border-t-indigo-600">
        <div className="p-3 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-xl w-fit mb-4 print:bg-white print:border print:border-indigo-200">
          <Code size={24} />
        </div>
      ...
      {/* CAPA 2: MITIGACIÓN */}
      <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-800 border-t-4 border-t-teal-500 relative flex flex-col print:shadow-none print:border-slate-300 print:border-t-teal-600">
        <div className="p-3 bg-teal-50 dark:bg-teal-900/30 text-teal-600 dark:text-teal-400 rounded-xl w-fit mb-4 print:bg-white print:border print:border-teal-200">
          <Network size={24} />
        </div>
      ...
      {/* CAPA 3: MONITOREO */}
      <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-800 border-t-4 border-t-sky-500 relative flex flex-col md:col-span-2 lg:col-span-1 print:shadow-none print:border-slate-300 print:border-t-sky-600">
        <div className="p-3 bg-sky-50 dark:bg-sky-900/30 text-sky-600 dark:text-sky-400 rounded-xl w-fit mb-4 print:bg-white print:border print:border-sky-200">
          <Eye size={24} />
        </div>
    ...
    <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 space-y-8 hover:shadow-lg transition-shadow print:shadow-none print:border-slate-300">
      ...
      <div className="border-l-4 border-emerald-500 pl-6 py-1">
        <h3 className="text-lg font-extrabold mb-4 text-slate-800 dark:text-slate-200 print:text-black flex items-center gap-2">
          <Wrench className="text-emerald-500" size={20}/> Fase 1: Errores y Configuración
        </h3>
      ...
      <div className="border-l-4 border-emerald-500 pl-6 py-1">
        <h3 className="text-lg font-extrabold mb-4 text-slate-800 dark:text-slate-200 print:text-black flex items-center gap-2">
          <PenTool className="text-emerald-500" size={20}/> Fase 2: Diseño UI/UX
        </h3>
        <div className="bg-slate-50 dark:bg-slate-950 p-5 rounded-xl border border-slate-100 dark:border-slate-800 mb-4 font-mono text-sm text-slate-600 dark:text-slate-400 print:bg-white print:border-slate-300 print:text-slate-800">
      ...
      <div className="border-l-4 border-emerald-500 pl-6 py-1">
        <h3 className="text-lg font-extrabold mb-4 text-slate-800 dark:text-slate-200 print:text-black flex items-center gap-2">
          <Cpu className="text-emerald-500" size={20}/> Fase 3: Exportación y Responsive
        </h3>
        <div className="bg-slate-50 dark:bg-slate-950 p-5 rounded-xl border border-slate-100 dark:border-slate-800 mb-4 font-mono text-sm text-slate-600 dark:text-slate-400 print:bg-white print:border-slate-300 print:text-slate-800">
