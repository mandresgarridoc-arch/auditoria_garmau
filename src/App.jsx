...
import { 
  ...
  QrCode, Download, Menu, X, FileText, CheckCircle
} from 'lucide-react';
        ...
        <div className="p-4 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/30 flex flex-col gap-4">
          ...
          <div className="pt-4 border-t border-slate-200 dark:border-slate-800 flex flex-col items-center gap-3">
            <span className="text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider text-center">
              Desarrollado por<br/>Mauricio Garrido
            </span>
            
            <div className="flex gap-2 w-full justify-center">
              <a href="https://github.com/mandresgarridoc-arch" target="_blank" rel="noreferrer" title="Github Mauricio Garrido" className="p-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
